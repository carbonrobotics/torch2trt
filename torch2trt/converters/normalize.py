...
#     input_trt = input._trt
    ...
    norm = ctx.network.add_reduce(norm, trt.ReduceOperation.SUM, torch_dim_to_trt_axes(dim, ctx.network.has_implicit_batch_dimension), keep_dims=True).get_output(0)
